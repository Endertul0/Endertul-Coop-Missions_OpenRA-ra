...
Beacon = {
    ...
    New = function(owner, position, duration, showRadarPings)
    end;
}
...
HSLColor = {
    ...
    ---@return color
    New = function(hue, saturation, luminosity)
    end;
...
Map = {
    ...
    ---@return actor[]
    ActorsInBox = function(topLeft, bottomRight, filter)
    end;
    ...
    ---@param filter? function
    ---@return actor[]
    ActorsInCircle = function(location, radius, filter)
    end;
    ...
    ---@param filter function
    ---@return cpos
    ClosestMatchingEdgeCell = function(givenCell, filter)
    end;

    --- Returns true if actor was originally specified in the map file.
    ---@param actor actor
    ---@return boolean
    IsNamedActor = function(actor)
    end;
...
Media = {
    ...
    ---@param text string
    ---@param prefix? string
    DisplaySystemMessage = function(text, prefix)
    end;
    ...
    PlaySoundNotification = function(player, notification)
    end;

    --- Play an announcer voice listed in notifications.yaml
    ---@param player player
    ---@param notification string
    PlaySpeechNotification = function(player, notification)
    end;
    ...
    ---@param track? string
    SetBackgroundMusic = function(track)
    end;
...
Radar = {
    ...
    ---@param color color
    ---@param duration? integer
    Ping = function(player, position, color, duration)
    end;
}
...
Reinforcements = {
    ...
    ---@return actor[]
    Reinforce = function(owner, actorTypes, entryPath, interval, actionFunc)
    end;
    ...
    ---@return table
    ReinforceWithTransport = function(owner, actorType, cargoTypes, entryPath, exitPath, actionFunc, exitFunc, dropRange)
    end;
}
...
Trigger = {
    ...
    ---@param delay integer
    ---@param func function
    AfterDelay = function(delay, func)
    end;
    ...
    Clear = function(actor, triggerName)
    end;
    ...
    ---@param actors actor[]
    ---@param func function
    OnAllKilledOrCaptured = function(actors, func)
    end;
    ...
    ---@param actors actor
    ---@param func function
    OnCapture = function(actors, func)
    end;
    ...
    ---@param actor actor
    ---@param func function
    OnDiscovered = function(actor, func)
    end;
    ...
    ---@param func function
    ---@return integer
    OnEnteredFootprint = function(cells, func)
    end;
    ...
    ---@param func function
    ---@return integer
    OnEnteredProximityTrigger = function(pos, range, func)
    end;
    ...
    ---@param func function
    ---@return integer
    OnExitedFootprint = function(cells, func)
    end;
    ...
    ---@param player player
    ---@param func function
    OnObjectiveAdded = function(player, func)
    end;
    ...
    ---@param player player
    ---@param func function
    OnObjectiveCompleted = function(player, func)
    end;
    ...
    ---@param player player
    ---@param func function
    OnObjectiveFailed = function(player, func)
    end;
    ...
    ---@param actor actor
    ---@param func function
    OnPassengerEntered = function(actor, func)
    end;
    ...
    ---@param actor actor
    ---@param func function
    OnPassengerExited = function(actor, func)
    end;
    ...
    ---@param player player
    ---@param func function
    OnPlayerWon = function(player, func)
    end;
...
Utils = {
    ...
    ---@return table
    Concat = function(firstCollection, secondCollection)
    end;

    --- Calls a function on every element in a collection.
    ---@param collection table
    ---@param func function
    Do = function(collection, func)
    end;
    ...
    ---@return cpos[]
    ExpandFootprint = function(footprint, allowDiagonal)
    end;
    ...
    ---@return string
    FormatTime = function(ticks, leadingMinuteZero)
    end;
    ...
    ---@return table
    Skip = function(table, numElements)
    end;
    ...
    ---@param func function
    ---@return table
    Where = function(collection, func)
    end;
}
...
local __actor = {
    ...
    ReturnToBase = function(destination)
    end;
    ...
    ---@param poolName? string
    ---@return integer
    MaximumAmmoCount = function(poolName)
    end;
    ...
    Reload = function(poolName, amount)
    end;
    ...
    ---@param target actor
    PickupCarryable = function(target)
    end;
    ...
    --- **Requires Trait:** [Carryall](https://docs.openra.net/en/release/traits/#carryall)
    ---@param target cpos
    DeliverCarryable = function(target)
    end;
    ...
    AttackMove = function(cell, closeEnough)
    end;
    ...
    ---@param loop? boolean
    ---@param wait? integer
    Patrol = function(waypoints, loop, wait)
    end;
    ...
    ---@param func function
    ---@param wait? integer
    PatrolUntil = function(waypoints, func, wait)
    end;
    ...
    Attack = function(targetActor, allowMove, forceAttack)
    end;
    ...
    ---@param targetActor actor
    ---@return boolean
    CanTarget = function(targetActor)
    end;
    ...
    ---@param duration? integer
    ---@return integer
    GrantCondition = function(condition, duration)
    end;

    --- Revoke a condition using the token returned by GrantCondition.
    --- **Requires Trait:** [ExternalCondition](https://docs.openra.net/en/release/traits/#externalcondition)
    ---@param token integer
    RevokeCondition = function(token)
    end;
    ...
    ---@param condition string
    ---@return boolean
    AcceptsCondition = function(condition)
    end;
    ...
    ---@param target actor
    DeliverExperience = function(target)
    end;
    ...
    GiveExperience = function(amount, silent)
    end;
    ...
    ---@param silent? boolean
    GiveLevels = function(numLevels, silent)
    end;
    ...
    ---@param interval? integer
    ---@param delay? integer
    Flash = function(color, count, interval, delay)
    end;
    ...
    ---@param closeEnough? integer
    ---@diagnostic disable-next-line: duplicate-index
    Move = function(cell, closeEnough)
    end;
    ...
    EnterTransport = function(transport)
    end;
    ...
    ---@param target cpos
    ActivateNukePower = function(target)
    end;
    ...
    Produce = function(actorType, factionVariant, productionType)
    end;
    ...
    ---@param actionFunc? function
    ---@return boolean
    Build = function(actorTypes, actionFunc)
    end;
    ...
    ---@param actorType string
    ---@return boolean
    IsProducing = function(actorType)
    end;
    ...
    StartBuildingRepairs = function(repairer)
    end;

    --- Stop repairs on this building. `repairer` can be an allied player.
    --- **Requires Trait:** [RepairableBuilding](https://docs.openra.net/en/release/traits/#repairablebuilding)
    ---@param repairer? player
    StopBuildingRepairs = function(repairer)
    end;
    ...
    ---@param target cpos
    ActivateIonCannon = function(target)
    end;
    ...
    DisguiseAsType = function(actorType, newOwner)
    end;
...
local __player = {
    ...
    ---@return boolean
    IsAlliedWith = function(targetPlayer)
    end;
    ...
    ---@return integer
    AddObjective = function(description, type, required)
    end;
    ...
    ---@param description string
    ---@return integer
    AddPrimaryObjective = function(description)
    end;
    ...
    ---@param description string
    ---@return integer
    AddSecondaryObjective = function(description)
    end;
    ...
    --- **Requires Trait:** [MissionObjectives](https://docs.openra.net/en/release/traits/#missionobjectives)
    ---@param id integer
    MarkCompletedObjective = function(id)
    end;
    ...
    --- **Requires Trait:** [MissionObjectives](https://docs.openra.net/en/release/traits/#missionobjectives)
    ---@param id integer
    MarkFailedObjective = function(id)
    end;
    ...
    ---@param id integer
    ---@return boolean
    IsObjectiveCompleted = function(id)
    end;
    ...
    ---@param id integer
    ---@return string
    GetObjectiveDescription = function(id)
    end;
    ...
    ---@param types string[]
    ---@return actor[]
    GetActorsByTypes = function(types)
    end;

    --- Check if the player has these prerequisites available.
    ---@param type string[]
    ---@return boolean
    HasPrerequisites = function(type)
    end;
    ...
    ---@param ticks integer
    TriggerPowerOutage = function(ticks)
    end;
